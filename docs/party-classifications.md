...
| list | junior partner | in range | share | `two-faction-list` |
|---|---|---|---|---|
| המילואימניקים והכלכלית | הכלכלית החדשה | **3 / 6** | 50% | **held** |
| ביחד | יש עתיד | **9 / 20** | 45% | **held** |
| עוצמה יהודית | ארץ ישראל שלנו | 2 / 10 | 20% | *not held* |
| ישר | יסודות ישראל | 3 / 30 | 10% | *not held* |
| הדמוקרטים | מרצ | 1 / 13 | 8% | *not held* |
| הליכוד | תקווה חדשה | 1 / 25 | 4% | *not held* |

**The gap between 45% and 20% is where the tag lives**, and no row sits in it. The measure was
