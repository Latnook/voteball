...
**2026-09-06 — revision 52. The 21-name list audited candidate by candidate, and the entry's
best-known claim — that this party makes NO territorial claim — is true of the platform and FALSE of
the party's own campaign material.** One tag added (13 → 14): `pro-settlement`. No axis moved.
...
**Three candidates could not be sourced at all** and are logged as gaps rather than guessed:
**אלווירה קוליכמן #9**, **יעקב (ינקי) מוזס #20** and **עמי קור #21** appear nowhere on
`beytenu.org.il` (searched across all 370 sitemap posts) and have no Hebrew Wikipedia page.
**List finality is also unverified** — lists are filed 2026-09-08 and no source obtained confirms
this order as submitted.
