...
נורמליזציה עם סעודיה ואינדונזיה"*, explicit and first-party. Its other holder is הדמוקרטים at
`security` **−1**, so the tag demonstrably crosses this axis and carries no directional signal.
