...
FROM (VALUES
    ...
    ('הדמוקרטים', 'opposition', -2, -1, -3, 'secular', ARRAY['progressive', 'social-democrat', 'liberal-zionist', 'religious-pluralism', 'jewish-arab-partnership', 'protest-movement-rooted', 'two-state']::text[], ARRAY['constitutional-reform','welfare-state','jewish-arab-partnership']::text[], 'platform'),
    ('כחול לבן', 'unaligned', 0, 2, -1, 'secular', ARRAY['centrist', 'hard-to-classify-bloc', 'statist', 'security-hawk', 'no-palestinian-state', 'pro-settlement', 'unity-government', 'public-service-reform', 'universal-conscription', 'sanctions-on-non-servers', 'arab-civil-service', 'scholar-exemption-retained']::text[], ARRAY['constitutional-reform','universal-conscription']::text[], 'platform'),
