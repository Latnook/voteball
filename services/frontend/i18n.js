...
const DICTIONARY = {
  en: {
    ...
    voteLeagueHint: "Pick as many clubs as you like — but at most 3 from any one domestic league. Or just the league, if you don't follow a specific club.",
    ...
    analyticsIncludeWorldCup: 'Include national teams',
    ...
    analyticsTraitsEvidenceRecord: 'from voting record in the Knesset',
  ...
  he: {
    ...
    voteLeagueHint: 'בחרו כמה קבוצות שתרצו — אך לא יותר מ-3 מאותה ליגה מקומית. או רק את הליגה, אם אינכם עוקבים אחרי קבוצה ספציפית.',
    ...
    analyticsIncludeWorldCup: 'כלול נבחרות לאומיות',
  ...
  ru: {
    ...
    voteLeagueHint: 'Выбирайте сколько угодно клубов — но не более 3 из одной национальной лиги. Или только лигу, если не следите за конкретным клубом.',
    ...
    analyticsIncludeWorldCup: 'Включить сборные',
    ...
    familyUniversalConscription: 'Всеобщая воинская повинность',
    familyConscriptionExemption: 'Освобождение ешив от воинской повинности',
    familyConscriptionSplit: 'Раскол по воинской повинности',
    ...
    familyWelfareState: 'Государство всеобщего благосостояния',
    ...
    analyticsTraitsEvidenceRecord: 'по результатам голосований в Кнессете',
