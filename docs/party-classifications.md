...
- ~~**#7–#12 are unsourced beyond the filing**~~ — **superseded 2026-09-08 by revision 63, which
  read the filing itself.** The list is **72 names**, not the twelve supplied, and every one is now
