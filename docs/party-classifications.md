...
**Two candidates remain genuinely unsourced** and are logged as gaps rather than guessed:
**יעקב (ינקי) מוזס #20** and **עמי קור #21** — no Hebrew Wikipedia page, and the party's own
full-text search returns nothing for either. **List finality is also unverified** — lists are filed
...
**⚠ 2026-09-06 — this row is reportedly becoming a TWO-PARTY LIST with יועז הנדל.**
