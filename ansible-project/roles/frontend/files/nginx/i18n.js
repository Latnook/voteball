...
const DICTIONARY = {
  en: {
    ...
    voteLegendLeague: 'League & club',
    voteLeagueHint: "Pick a league, then your club — or just the league if you don't follow one closely.",
    ...
    voteSubmit: 'Submit your line-up',
  ...
  he: {
    ...
    voteLegendLeague: 'ליגה וקבוצה',
    voteLeagueHint: 'בחרו ליגה, ואז את הקבוצה שלכם — או רק את הליגה אם אינכם עוקבים אחרי קבוצה ספציפית.',
