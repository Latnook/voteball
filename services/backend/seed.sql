...
FROM (VALUES
    ...
    ('כחול לבן', 'unaligned', 0, 2, -1, 'secular', ARRAY['centrist', 'hard-to-classify-bloc', 'statist', 'security-hawk', 'no-palestinian-state', 'pro-settlement', 'unity-government', 'public-service-reform']::text[], ARRAY['constitutional-reform']::text[], 'platform'),
